...
# 2. Check for indicators of USB device entry.
# 3. Parse lines for timestamp and device information.
# 4. Output the result to the user.
# Learn Python For Forensics, authors Preston Miller & Chapin Bryce.
# version 0.03
